...
![Example of mismatched road types on the way from home to ZHAW (only train from Rapperswil to Wädenswil).](plots/road_type_pie_comp.png){#fig-road_type_mismatch}
